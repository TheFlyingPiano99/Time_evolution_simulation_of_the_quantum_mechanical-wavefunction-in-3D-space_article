...
Inspired by the previously enumerated large amount of various fields of application we set the goal to study the behavior of quantum systems by computer simulation.
